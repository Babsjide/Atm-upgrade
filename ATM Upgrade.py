import random
database= {'email': 'jideodus9@gmail.com'  , 'first_name': 'Babajide' , 'last_name' : 'Odusanya', 'Password': 'Bjay', 'account_number': 1234567890}


def init():
   
    valid_option = False
    print('Welcome to The Common Wealth Bank')
